  ...
  return (
    <section className="relative px-6 md:px-12 pb-16 pt-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col items-center text-center mt-12 mb-16">
        <h1 className="text-5xl md:text-7xl font-display font-medium max-w-4xl tracking-tight leading-[1.1] mb-6">
          Empowering Electric Motion Technology
        </h1>
        <p className="text-gray-400 max-w-2xl text-sm md:text-base text-balance">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4 h-[600px] md:h-[500px]">
        ...
        <div className="col-span-1 row-span-1 bg-primary rounded-3xl p-6 flex flex-col justify-end text-dark">
          <h3 className="font-display font-semibold text-2xl leading-tight">Electric<br/>Mobility</h3>
        </div>
        ...
        <div className="col-span-1 row-span-1 bg-dark-surface rounded-3xl p-6 flex items-start border border-dark-border">
          <h3 className="font-display font-medium text-lg leading-tight">Motion<br/>Technology</h3>
        </div>

        {/* Box 5: Cleaner Future Green box */}
        <div className="col-span-1 row-span-1 bg-primary rounded-3xl p-6 flex flex-col justify-end text-dark relative overflow-hidden">
          ...
          <h3 className="font-display font-semibold text-2xl leading-tight">Cleaner<br/>Future</h3>
        </div>
      </div>
