        ...
        <div className="flex justify-center max-w-5xl mx-auto w-full">
           <div className="grid grid-cols-2 md:grid-cols-4 md:grid-rows-2 gap-4 h-[500px] w-full">
              ...
              <div className="col-span-2 row-span-2 rounded-3xl overflow-hidden relative">
                 <Image src="https://images.unsplash.com/photo-1572949645841-094f3a9c4c94?q=80&w=600&auto=format&fit=crop" alt="EV Charger" fill className="object-cover" referrerPolicy="no-referrer" />
              </div>
               ...
               <div className="col-span-1 row-span-1 border border-gray-300 rounded-3xl overflow-hidden relative p-8 flex flex-col justify-end">
                  ...
                  <Image src="https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?q=80&w=400&auto=format&fit=crop" alt="Map graphic" fill className="object-cover opacity-20 grayscale mix-blend-multiply" referrerPolicy="no-referrer" />
               ...
               <div className="col-span-1 bg-gray-200 rounded-3xl overflow-hidden relative">
                  <Image src="https://images.unsplash.com/photo-1519003300449-424ad0405076?q=80&w=300&auto=format&fit=crop" alt="Dashboard" fill className="object-cover" referrerPolicy="no-referrer" />
               </div>
               
               <div className="col-span-1 bg-gray-200 rounded-3xl overflow-hidden relative">
                   <Image src="https://images.unsplash.com/photo-1493246507139-91e8fad9978e?q=80&w=300&auto=format&fit=crop" alt="Wheel" fill className="object-cover" referrerPolicy="no-referrer" />
               </div>
           </div>
        </div>
