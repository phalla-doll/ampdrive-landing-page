  ...
  return (
    <section className="bg-[#F2F4F8] text-dark py-24 px-6 md:px-12 w-full">
      <div className="max-w-7xl mx-auto flex flex-col gap-12 text-center">
        ...
        <h2 className="text-4xl md:text-5xl font-display font-medium tracking-tight">Our Electric Purpose</h2>
           ...
           <div className="grid grid-cols-2 md:grid-cols-4 md:grid-rows-2 gap-4 h-[500px] w-full">
              ...
              <div className="col-span-2 row-span-2 rounded-3xl overflow-hidden relative">
               ...
               <div className="col-span-1 row-span-1 bg-primary rounded-3xl overflow-hidden relative p-6 flex flex-col justify-end text-dark">
                  ...
                  <h3 className="font-display font-semibold text-lg leading-tight relative z-10">Innovative<br/>Solutions</h3>
               </div>
               
               <div className="col-span-1 row-span-1 border border-gray-300 rounded-3xl overflow-hidden relative p-6 flex flex-col justify-end">
                  ...
                  <h3 className="font-display font-semibold text-lg leading-tight relative z-10 text-right">Charging<br/>Solutions</h3>
               </div>
        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-24 text-left mt-8">
           <div className="md:w-1/2">
             <p className="text-gray-600 font-medium leading-relaxed text-sm max-w-sm">
