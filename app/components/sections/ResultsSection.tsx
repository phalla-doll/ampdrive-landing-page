  ...
  return (
    <section className="bg-white text-dark py-24 px-6 md:px-12 w-full">
      <div className="max-w-7xl mx-auto flex flex-col gap-16 relative">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-8 border-b border-gray-200 pb-16">
          <h2 className="text-4xl md:text-5xl font-display font-medium tracking-tight max-w-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-dark text-white rounded-3xl p-12 md:p-16 flex flex-col justify-between h-[300px]">
             <div className="flex items-baseline gap-2">
               <span className="text-2xl font-bold uppercase tracking-widest text-primary">Top</span>
               <span className="text-8xl md:text-[140px] leading-none font-display font-medium tracking-tighter">20</span>
             </div>
             <p className="max-w-[200px] text-xs font-bold uppercase tracking-wider text-gray-400">
          ...
          <div className="bg-primary text-dark rounded-3xl p-12 md:p-16 flex flex-col justify-between h-[300px]">
             <div className="flex items-baseline gap-2">
               <span className="text-2xl font-bold uppercase tracking-widest text-dark/60">Top</span>
             ...
             <p className="max-w-[200px] text-xs font-bold uppercase tracking-wider text-dark/70">
