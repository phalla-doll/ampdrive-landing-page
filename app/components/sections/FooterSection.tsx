  ...
  return (
    <footer className="bg-dark text-white pt-24 pb-12 px-6 md:px-12 w-full relative">
      ...
      <div className="max-w-5xl mx-auto bg-[#F2F4F8] text-dark rounded-3xl p-12 md:p-20 relative -mt-48 mb-24 shadow-2xl overflow-hidden flex flex-col md:flex-row items-center justify-between gap-12">
         ...
         <h2 className="text-4xl md:text-[4rem] font-display font-medium tracking-tight leading-[1] max-w-sm">
           Get In Touch
         </h2>
         
         <div className="flex flex-col items-start gap-6 relative z-10 w-full max-w-sm md:pt-4">
            <button className="w-16 h-16 bg-primary text-dark rounded-xl flex items-center justify-center hover:bg-primary-light transition-colors transform hover:scale-105 shadow-xl shadow-primary/20">
               <span className="text-2xl font-medium">&rarr;</span>
            </button>
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-end pb-12 border-b border-gray-800 gap-12 mt-8">
        <div className="flex items-center gap-3">
          <div className="w-5 h-5 bg-primary rotate-45" />
          <span className="text-xl font-medium tracking-widest uppercase font-display">Ampdrive</span>
        </div>
